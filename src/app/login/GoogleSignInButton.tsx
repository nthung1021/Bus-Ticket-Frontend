...
export default function GoogleSignInButton() {
  ...
  return (
    <button
      ...
      className="w-full flex items-center justify-center gap-2 bg-card border border-border rounded-md shadow-sm py-2 px-4 text-sm font-medium text-card-foreground hover:bg-muted transition-colors"
    >
