...
export default function GoogleSignInButton() {
  ...
  return (
    <button
      ...
      className="w-full flex items-center justify-center gap-2 bg-background border border-input rounded-md shadow-sm py-2 px-4 text-sm font-medium text-foreground hover:bg-accent hover:text-accent-foreground transition-colors"
    >
