          ...
          <div className="hidden md:flex items-center space-x-4">
            {!user ? (
              ...
              <div className="flex items-center space-x-4">
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger className="flex items-center space-x-2 p-2 rounded-full hover:bg-muted/50 transition-colors">
              ...
              {!user ? (
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-2">
                    <Link 
                      href="/user/profile"
                      className="flex items-center space-x-3 text-body text-muted-foreground hover:text-foreground transition-colors py-2"
                    >
